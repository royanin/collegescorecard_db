"""
A quick script to check that the databases are working once they are loaded
"""
...
u = db.session.query(School_details).filter_by(id=5).first()
print u.r_fin_NPT4_COMB, u.r_fin_RET_FT4_COMB, u.r_fin_PFTFTUG1_EF
